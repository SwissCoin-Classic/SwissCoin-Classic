...
This document provides guidelines for internationalization of the SwissCoin Classic software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `swisscoinclassic_en.ts` remains unchanged.
