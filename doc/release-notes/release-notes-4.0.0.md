...
A command to generate a private payment has been added. SwissCoinClassic Core will take care of the negotiation with the NAVTech nodes and will create and broadcast the transaction. The syntax is:
