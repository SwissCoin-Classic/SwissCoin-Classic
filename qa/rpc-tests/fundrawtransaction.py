...
class RawTransactionsTest(SwissCoinClassicTestFramework):
    ...
    def run_test(self):
        ...
        try:
            ...
            raise AssertionError("Accepted invalid swisscoinclassic address")
        except JSONRPCException as e:
            assert("changeAddress must be a valid swisscoinclassic address" in e.error['message'])
