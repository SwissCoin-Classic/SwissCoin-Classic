...
class ZapWalletTXesTest (SwissCoinClassicTestFramework):
    ...
    def run_test (self):
        ...
        #restart swisscoinclassicd
        self.nodes[0].stop()
        swisscoinclassicd_processes[0].wait()
        ...
        #restart swisscoinclassicd with zapwallettxes
