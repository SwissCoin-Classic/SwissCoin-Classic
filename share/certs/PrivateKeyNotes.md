...
unlocked to sign the SwissCoinClassic-Qt.app bundle.
...
allowing somebody to distribute a SwissCoinClassic-Qt.app or swisscoinclassic-qt-setup.exe with a valid
...
that the swisscoinclassic-qt.exe file inside the installer had not been tampered with.
