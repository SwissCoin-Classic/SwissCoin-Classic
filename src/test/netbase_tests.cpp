...
{
    BOOST_CHECK(TestSplitHost("www.swisscoinclassic.org", "www.swisscoinclassic.org", -1));
    BOOST_CHECK(TestSplitHost("[www.swisscoinclassic.org]", "www.swisscoinclassic.org", -1));
    BOOST_CHECK(TestSplitHost("www.swisscoinclassic.org:80", "www.swisscoinclassic.org", 80));
    BOOST_CHECK(TestSplitHost("[www.swisscoinclassic.org]:80", "www.swisscoinclassic.org", 80));
