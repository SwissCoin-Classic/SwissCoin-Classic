...
#ifndef SWISSCOINCLASSIC_TEST_SCRIPTNUM10_H
#define SWISSCOINCLASSIC_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from SwissCoin Classic 0.10.0, for cross-comparison.
 */
public:
...
#endif // SWISSCOINCLASSIC_TEST_BIGNUM_H
