...
#define BOOST_TEST_MODULE SwissCoin Classic Test Suite

#include "test_swisscoinclassic.h"
...
TestingSetup::TestingSetup(const std::string& chainName) : BasicTestingSetup(chainName)
{
    const CChainParams& chainparams = Params();
        ...
        ClearDatadirCache();
        pathTemp = GetTempPath() / strprintf("test_swisscoinclassic_%lu_%i", (unsigned long)GetTime(), (int)(GetRand(100000)));
