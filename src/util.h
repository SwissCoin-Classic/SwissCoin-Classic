 ...
 */
#ifndef SWISSCOINCLASSIC_UTIL_H
#define SWISSCOINCLASSIC_UTIL_H
...
extern const char * const SWISSCOINCLASSIC_CONF_FILENAME;
extern const char * const SWISSCOINCLASSIC_PID_FILENAME;
...
{
    std::string s = strprintf("swisscoinclassic-%s", name);
