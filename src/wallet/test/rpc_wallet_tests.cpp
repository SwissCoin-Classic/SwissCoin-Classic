...
BOOST_AUTO_TEST_CASE(rpc_wallet)
{
    ...
    UniValue r;
    CPubKey demoPubkey;
    CSwissCoinClassicAddress demoAddress;
    UniValue retValue;
    string strAccount = "walletDemoAccount";
    CSwissCoinClassicAddress setaccountDemoAddress;
    {
        LOCK(pwalletMain->cs_wallet);

        demoPubkey = pwalletMain->GenerateNewKey();
        demoAddress = CSwissCoinClassicAddress(CTxDestination(demoPubkey.GetID()));
        ...
        setaccountDemoAddress = CSwissCoinClassicAddress(CTxDestination(setaccountDemoPubkey.GetID()));
    }
    /*********************************
     * 			setaccount
     *********************************/
    ...
    BOOST_CHECK(CSwissCoinClassicAddress(retValue.get_str()).Get() == demoAddress.Get());
    ...
    BOOST_CHECK(CSwissCoinClassicAddress(arr[0].get_str()).Get() == demoAddress.Get());
