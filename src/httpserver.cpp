...
{
    RenameThread("swisscoinclassic-http");
...
{
    RenameThread("swisscoinclassic-httpworker");
    queue->Run();
}
...
void StopHTTPServer()
{
    ...
    if (eventBase) {
        ...
        // (see discussion in https://github.com/swisscoinclassic/swisscoinclassic/pull/6990)
