...
#ifndef SWISSCOINCLASSIC_QT_WALLETVIEW_H
#define SWISSCOINCLASSIC_QT_WALLETVIEW_H
...
public:
    ...
    void setSwissCoinClassicGUI(SwissCoinClassicGUI *gui);
...
Q_SIGNALS:
    ...
    friend SwissCoinClassicGUI;
};

#endif // SWISSCOINCLASSIC_QT_WALLETVIEW_H
