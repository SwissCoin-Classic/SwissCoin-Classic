...
#ifndef SWISSCOINCLASSIC_QT_SENDCOINSDIALOG_H
#define SWISSCOINCLASSIC_QT_SENDCOINSDIALOG_H
...
/** Dialog for sending swisscoinclassics */
...
#endif // SWISSCOINCLASSIC_QT_SENDCOINSDIALOG_H
