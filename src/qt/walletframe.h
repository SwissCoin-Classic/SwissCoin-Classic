...
#ifndef SWISSCOINCLASSIC_QT_WALLETFRAME_H
#define SWISSCOINCLASSIC_QT_WALLETFRAME_H
...
public:
    explicit WalletFrame(const PlatformStyle *platformStyle, SwissCoinClassicGUI *_gui = 0);
    ~WalletFrame();
...
#endif // SWISSCOINCLASSIC_QT_WALLETFRAME_H
