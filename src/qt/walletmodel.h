...
#ifndef SWISSCOINCLASSIC_QT_WALLETMODEL_H
#define SWISSCOINCLASSIC_QT_WALLETMODEL_H
...
/** Interface to SwissCoin Classic wallet from Qt view code. */
...
#endif // SWISSCOINCLASSIC_QT_WALLETMODEL_H
