    ...
    mapper(0)
{
    ...
    ui->swisscoinclassicAtStartup->setToolTip(ui->swisscoinclassicAtStartup->toolTip().arg(tr(PACKAGE_NAME)));
    ui->swisscoinclassicAtStartup->setText(ui->swisscoinclassicAtStartup->text().arg(tr(PACKAGE_NAME)));
    ...
    ui->unit->setModel(new SwissCoinClassicUnits(this));
...
{
    /* Main */
    mapper->addMapping(ui->swisscoinclassicAtStartup, OptionsModel::StartAtStartup);
...
void OptionsDialog::on_openSwissCoinClassicConfButton_clicked()
{
      ...
      GUIUtil::openSwissCoinClassicConf();
 }
