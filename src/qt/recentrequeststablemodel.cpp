    ...
    if(role == Qt::DisplayRole || role == Qt::EditRole)
    {
        ...
        case Amount:
            if (rec->recipient.amount == 0 && role == Qt::DisplayRole)
                ...
                return SwissCoinClassicUnits::format(walletModel->getOptionsModel()->getDisplayUnit(), rec->recipient.amount, false, SwissCoinClassicUnits::separatorNever);
            else
                return SwissCoinClassicUnits::format(walletModel->getOptionsModel()->getDisplayUnit(), rec->recipient.amount);
        }
    }
...
{
    return (this->walletModel->getOptionsModel() != NULL) ? tr("Requested") + " ("+SwissCoinClassicUnits::name(this->walletModel->getOptionsModel()->getDisplayUnit()) + ")" : "";
}
