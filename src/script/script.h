...
#ifndef SWISSCOINCLASSIC_SCRIPT_SCRIPT_H
#define SWISSCOINCLASSIC_SCRIPT_SCRIPT_H
...
public:
    ...
    /**
     * Pre-version-0.6, SwissCoin Classic always counted CHECKMULTISIGs
...
#endif // SWISSCOINCLASSIC_SCRIPT_SCRIPT_H
